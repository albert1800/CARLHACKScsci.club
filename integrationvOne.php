			...
			<div class="wrapper header">
				...
				<div class="clearfix header_top">
					<div class="clearfix logo floatleft">
						...
						<a href="mailto:csciclub@stcloudstate.edu"><h3 style="font-family:courier; color:yellow;">csciclub@stcloudstate.edu<h3></a>
					</div>
				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						...
						echo ' <div class=\"clearfix single_content\">
							...
							<h2><a href=\"http://recode.net/2016/04/08/senate-draft-encryption-bill-dangerous/\">' ;
								 echo $r->postTitle;
								echo "</a></h2>
						...
						<div class="clearfix single_content">
							...
							<div class="clearfix post_detail">
								<h2><a href="http://www.stcloudstate.edu/programs/software-engineering/default.aspx?utm_source=web&utm_medium=free&utm_content=edu-carousel&utm_campaign=software-engineering"> Software Engineering - NOW in SCSCU!!! </a></h2>
								<div class="clearfix post-meta">
		...
		<section id="footer_bottom_area">
			<div class="clearfix wrapper footer_bottom">
				<div class="clearfix copyright floatleft">
					<p> Copyright &copy; All rights reserved by <span>CSCI.Club</span></p>
				</div>
